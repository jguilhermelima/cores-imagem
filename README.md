<h1 align="center"> Cores Imagem </h1>
...
* Selecionar imagem salva no computador clicando no botão Selecionar Imagem.

* Clicar no botão Pegar Cor para processar e mostar os códigos hexadecimais.
